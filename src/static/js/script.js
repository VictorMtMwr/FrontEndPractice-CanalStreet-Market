document.querySelectorAll('.panel').forEach(x => x.addEventListener('click', ()=> {
      ...
      if(document.querySelector('.one').classList.contains('active')){
       ...
       <div class="flex food-hall-container">
        ...
        <div class="food-img"><img src="static/images/c3.png" alt=""></div>
       </div>
        ...
        <div class="menu-grid">
          ...
          <div class="img-hover">
            ...
            <img class="rice-roll-img" src="static/images/rollo.jpg" alt="">
          </div>
          <div>
      ...
      if(document.querySelector('.two').classList.contains('active')){
        ...
        <div class="flex food-hall-container">
         ...
         <div class="food-img"><img src="static/images/c2.png" alt=""></div>
        </div>
       ...
       if(document.querySelector('.three').classList.contains('active')){
        ...
        <div class="flex food-hall-container">
         ...
         <div class="food-img"><img src="static/images/c1.png" alt=""></div>
        </div>
